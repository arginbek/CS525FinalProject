...
public class JDialog_AddCCAccount extends javax.swing.JDialog {
	...
	public JDialog_AddCCAccount(CardFrm parent) {
		...
		JRadioButton_Company.addMouseListener(aSymMouse);
		JRadioButton_Personal.addMouseListener(aSymMouse);

		JRadioButton_Personal.setText("Personal");
		JRadioButton_Personal.setActionCommand("AccountType");
		getContentPane().add(JRadioButton_Personal);
		JRadioButton_Personal.setBounds(120, 12, 84, 24);

		JRadioButton_Company.setText("Company");
		JRadioButton_Company.setActionCommand("AccountType");
		getContentPane().add(JRadioButton_Company);
		JRadioButton_Company.setBounds(120, 36, 84, 24);
		// }}
	}
	...
	class SymMouse extends java.awt.event.MouseAdapter {
		public void mouseClicked(java.awt.event.MouseEvent event) {
			...
			else if (object == JRadioButton_Personal)
				JRadioButtonPersonal_mouseClicked(event);
			else if (object == JRadioButton_Company)
				JRadioButtonCompany_mouseClicked(event);
		}
	}
	...
	void JRadioButtonPersonal_mouseClicked(java.awt.event.MouseEvent event) {
		JRadioButton_Company.setSelected(false);
		JRadioButton_Personal.setSelected(true);

	}

	void JRadioButtonCompany_mouseClicked(java.awt.event.MouseEvent event) {
		JRadioButton_Company.setSelected(true);
		JRadioButton_Personal.setSelected(false);
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		if (JRadioButton_Gold.isSelected())
			parentframe.cardType = "Gold";
		else {
			if (JRadioButton_Silver.isSelected())
				parentframe.cardType = "Silver";
			else
				parentframe.cardType = "Bronze";
		}
		
		parentframe.accountType = JRadioButton_Personal.isSelected() ? "Personal" : "Company";
